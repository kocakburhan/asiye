---
name: summarization
description: Summarize text using extractive, abstractive, hierarchical, and multi-document techniques, producing concise outputs at configurable detail levels. Use when the user asks to summarize, condense, create a TLDR, make a summary, digest a document, or synthesize multiple documents into a single overview.
license: MIT
metadata:
