---
name: fact-checking
description: Verify the accuracy of claims and statements by extracting individual assertions, identifying authoritative sources, cross-referencing evidence, and assigning confidence-scored verdicts. Use when the user asks to fact-check, verify a claim, check if something is true, validate a statement, or assess the accuracy of text containing factual claims.
license: MIT
metadata:
