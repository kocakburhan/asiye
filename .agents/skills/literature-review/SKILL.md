...
description: Conduct a structured literature review on a given topic by defining a search strategy, applying inclusion and exclusion criteria, extracting key findings, and synthesizing results into a coherent academic review. Use when the user asks to do a literature review, survey academic papers, conduct a systematic review, analyze research on a topic, or needs a PRISMA-style research synthesis.
license: MIT
metadata:
